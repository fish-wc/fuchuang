...
if __name__ == '__main__':
	...
	conf = {"choice":args.choice,"no_models":args.no_models,"model_name":args.model_name,"type":args.type,"global_epochs":args.global_epochs,
			"local_epochs":args.local_epochs,"k":args.k,"batch_size":args.batch_size,"lr":args.lr,"momentum":args.momentum,"lambda_":args.lambda_,"dp":args.dp,"C":args.C,"sigma":args.sigma,"q":args.q,"w":args.w,"feature_num":args.feature_num,
			"eta":args.eta,"alpha":args.alpha,"poison_label":args.poison_label,"poisoning_per_batch":args.poisoning_per_batch,"prop":args.prop,"root":args.root}
